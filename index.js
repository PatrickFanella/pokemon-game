...
// Create an array of arrays each 70 long to mimic our map grid
const collisionsMap = [];
...
// sets position of each boundary & battlezone i = row j = column, * 48 because of map scale size
const boundaries = [];
...
//create html image object and point to it's
